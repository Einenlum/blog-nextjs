...
export const meta = {
    articleTitle: 'Lessons learned about Bus Factor (Part 4/5): Stay close to the domain',
...
![](https://miro.medium.com/max/1400/1*DobtLksArQBUEeB-qMA2dw.jpeg)“_The Entire City_” by Max Ernst
