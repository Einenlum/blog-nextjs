...
export const meta = {
    ...
    description: 'Writing good code is not only about architectural patterns. It\'s always linked to your final users and to the domain you are working for.',

}

<WithSyntaxHighlighting languages={['gherkin']}>
