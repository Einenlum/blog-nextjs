...
export const meta = {
    articleTitle: 'A free CI (using Docker-Compose) for your Gitlab repositories?',
...
![](https://miro.medium.com/max/1400/1*UpEU7VjL87DbgUPiDxzTnA.jpeg)
...
**I have an issue with the network. Containers cannot communicate with each others… Maybe I can play with the network options (network\_mode?).  
If a docker expert is here, I would love some help :)**

_Image by_ [_Paradasos_](https://www.flickr.com/photos/paradasos/7234825030/) _(CC by/nc)_
